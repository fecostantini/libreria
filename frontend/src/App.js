			...
			<div className='card mt-5 py-5'>
				<div className='card-body'>
					...
					<form onSubmit={this.handleSubmit.bind(this)}>
						...
						<div className='form-group row'>
							<label className='col-sm-4 col-lg-2 col-form-label'>Titulo</label>
							<div className='col-sm-8 col-lg-4'>
								<input
									type='text'
									className='form-control'
						...
						<div className='form-group row'>
							<label className='col-sm-4 col-lg-2 col-form-label'>Idioma</label>
							<div className='col-sm-8 col-lg-4'>
								<input
									type='text'
									className='form-control'
						...
						<div className='form-group row'>
							<label className='col-sm-4 col-lg-2 col-form-label'>Stock</label>
							<div className='col-sm-8 col-lg-4'>
								<input
									type='number'
									className='form-control'
